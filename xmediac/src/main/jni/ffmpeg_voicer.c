#include <com_sunsty_xmediac_util_VideoPlayer.h>
...
//音频解码
JNIEXPORT void JNICALL Java_com_sunsty_xmediac_util_VideoPlayer_audioDecode
...
//音频播放
JNIEXPORT void JNICALL Java_com_sunsty_xmediac_util_VideoPlayer_audioPlayer
(JNIEnv *env, jobject jobj, jstring input_jstr) {
    ...
    jclass cls = (*env)->FindClass(env, "com/sunsty/xmediac/util/AudioUtil");
     //jmethodID
