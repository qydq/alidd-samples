package com.sunsty.alidd.view.activity.picture.adapter;
...
import com.ali.module.lib.tools.DateUtils;
import com.ali.module.lib.tools.SdkVersionUtils;
...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.base_drawable_add);
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                ...
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                        (R.drawable.ic_picture_audio, 0, 0, 0);

            } else {
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                        (R.drawable.ic_picture_video, 0, 0, 0);
            }
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                ...
                RequestOptions options = new RequestOptions()
                        .centerCrop()
                        .placeholder(R.color.an_color_line_one)/////////////sunline_one
