...
- [android快速集成基础框架 - Livery```1.1.43```](#android%E5%BF%AB%E9%80%9F%E9%9B%86%E6%88%90%E5%9F%BA%E7%A1%80%E6%A1%86%E6%9E%B6---livery1124)
...
[![JCenter](https://img.shields.io/badge/%20JCenter%20-1.1.43-5bc0de.svg)](https://bintray.com/qydq/maven/livery/_latestVersion)
...
[![Release Version](https://img.shields.io/badge/release-1.1.43-red.svg)](https://github.com/qydq/small-video-record/releases)
...
&#8194;&#8194;&#8194;&#8194;&#8194;[**最新体验扫描二维码下载hong1.1.43.apk**](https://github.com/qydq/alidd-samples/raw/master/apk/demo_livery1.1.43.apk)&#8194;&#8194;&#8194;&#8194;
## 集成方式# Binaries
第1步骤：  在你项目（app module）的build.gradle中添加（致谢JitPack和Jcenter）.
```Groovy
dependencies {
  implementation'com.sunsta.livery:livery:1.1.43'
}
```
...
|**v1.1.43** *`(2020/06/03)`*| 240M |  17.1M   | 1.0M | 1.1.16版本再次移除了一些非必须的资源文件，增加优化了已知问题，继承的体积再此压缩到1M以下|
