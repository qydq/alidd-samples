...
- [android快速集成基础框架 - Livery```1.1.103```](#android%E5%BF%AB%E9%80%9F%E9%9B%86%E6%88%90%E5%9F%BA%E7%A1%80%E6%A1%86%E6%9E%B6---livery1124)
...
# android快速集成基础框架 - Livery```1.1.103```
...
[![JCenter](https://img.shields.io/badge/%20JCenter%20-1.1.103-5bc0de.svg)](https://bintray.com/qydq/maven/livery/_latestVersion)
...
[![Release Version](https://img.shields.io/badge/release-1.1.103-red.svg)](https://github.com/qydq/small-video-record/releases)
...
&#8194;&#8194;&#8194;&#8194;&#8194;[**最新体验扫描二维码下载hong1.1.103.apk**](https://github.com/qydq/alidd-samples/raw/master/apk/demo_livery1.1.103.apk)&#8194;&#8194;&#8194;&#8194;
## 集成方式# Binaries
集成方式有以下两种：
...
```Groovy
dependencies {
  implementation'com.sunsta.livery:livery:1.1.103'
}
```
...
第1步骤： 在链接:https://pan.baidu.com/s/1_NtHc-AlTaw3ka2aoeqQ_A  密码:16f2；下载Livery最新版本文件livery1.1.103.aar

然后将文件拷贝到libs目录中添加引用关系：

```Groovy
dependencies {
  implementation(name:'livery1.1.103', ext:'aar')
}
```
...
|**v1.1.103** *`(2020/06/03)`*| 230M |  17.1M   | 603M | 1.1.103优化了一些已知问题|
