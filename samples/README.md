...
implementation 'com.sunsta.bear:bear:1.0.7'
...
（python开发一些工具， 扫码支付后，可以使用，使用一次扫描一次，价格定为：0.99元每一次）
...
1.包名格式：
com.livery.demo.module.pager.xxx

2.类名格式：
主类：MainPagerActivity.java

3.布局格式：
主布局：pager_activity_main.xml
主布局：pager_activity_xxx.xml
次要布局：item_pager_viewpager.xml

4.资源文件：
图片：pager_xxx.png
pager_drawable_xxx.xml
动画：pager_animation.xml
...
com.sunsta.bear.listener.OnItemClickListener

---livery(***提供对外，AndroidManifest.xml)
com.sunsta.bear.AnApplication
com.sunsta.livery.view.INASwipeLayout
com.sunsta.livery.view.activity.PictureSelector
---picture(***module支持， =========or ==
even just empty
