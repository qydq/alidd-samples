...
//        JustNet.getInstance().justWith().observableGet("json");
        ...
        justManager.add(((BaseNetApi<ResponseBody>) InternetClient.getInstance().api("https://www.wanandroid.com/banner/", BaseNetApi.class))
                .observableGet("json")
...
//                startActivity(new Intent(BeforeSelectAlbumActivity.this, WebViewActivity.class));
    ...
    private void turnBiniNet() {
        BaseNetApi api = InternetClient.getInstance().getRetrofit("https://www.wanandroid.com/banner/").create(BaseNetApi.class);
