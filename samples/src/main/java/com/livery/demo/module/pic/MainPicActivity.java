...
import com.livery.demo.module.pic.adapter.GridImageAdapter;
import com.livery.demo.module.pic.listener.DragListener;
...
import com.sunsta.livery.language.LanguageConfig;
...
public class MainPicActivity extends AppCompatActivity implements View.OnClickListener,
        RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener {
    private final static String TAG = MainPicActivity.class.getSimpleName();
            ...
            if (selectList.size() > 0) {
                ...
                switch (mediaType) {
                    case PictureConfig.TYPE_VIDEO:
                        // 预览视频
                        PictureSelector.create(MainPicActivity.this)
        ...
        mDragListener = new DragListener() {
            ...
            public void deleteState(boolean isDelete) {
                if (isDelete) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                        tvDeleteText.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.ic_white_delete, 0, 0);
                    }
                }
            }
                        ...
                        .forResult(new OnResultCallbackListener<LocalMedia>() {
                            ...
                            public void onResult(List<LocalMedia> result) {
                                for (LocalMedia media : result) {
                                    LaLog.i(TAG, "是否压缩:" + media.isCompressed());
                                    LaLog.i(TAG, "压缩:" + media.getCompressPath());
                                    LaLog.i(TAG, "原图:" + media.getPath());
                                    LaLog.i(TAG, "是否裁剪:" + media.isCut());
                                    LaLog.i(TAG, "裁剪:" + media.getCutPath());
                                    LaLog.i(TAG, "是否开启原图:" + media.isOriginal());
                                    LaLog.i(TAG, "原图路径:" + media.getOriginalPath());
                                    LaLog.i(TAG, "Android Q 特有Path:" + media.getAndroidQToPath());
                                    LaLog.i(TAG, "宽高: " + media.getWidth() + "x" + media.getHeight());
                                    LaLog.i(TAG, "Size: " + media.getSize());
                            ...
                            public void onCancel() {
                                LaLog.i(TAG, "PictureSelector Cancel");
                            }
                        });
            } else {
                // 单独拍照
...
//                    }
    ...
    private void getDefaultStyle() {
        ...
        // 相册列表标题栏右侧上拉箭头
        mPictureParameterStyle.pictureTitleUpResId = R.drawable.ic_white_arrow_up;
        // 相册列表标题栏右侧下拉箭头
        mPictureParameterStyle.pictureTitleDownResId = R.drawable.ic_white_arrow_down;
        // 相册文件夹列表选中圆点
        mPictureParameterStyle.pictureFolderCheckedDotStyle = R.drawable.picture_orange_oval;
        // 相册返回箭头
        mPictureParameterStyle.pictureLeftBackIcon = R.drawable.ic_white_back;
        // 标题栏字体颜色
        ...
        // 外部预览界面删除按钮样式
        mPictureParameterStyle.pictureExternalPreviewDeleteStyle = R.drawable.ic_white_delete;
...
//        mPictureParameterStyle.pictureOriginalTextSize = 14;
    ...
    private void getWeChatStyle() {
        ...
        // 相册列表标题栏右侧上拉箭头
        mPictureParameterStyle.pictureTitleUpResId = R.drawable.ic_color_wechat_up;
        // 相册列表标题栏右侧下拉箭头
        mPictureParameterStyle.pictureTitleDownResId = R.drawable.ic_color_wechat_down;
        // 相册文件夹列表选中圆点
        mPictureParameterStyle.pictureFolderCheckedDotStyle = R.drawable.picture_orange_oval;
        // 相册返回箭头
        mPictureParameterStyle.pictureLeftBackIcon = R.drawable.ic_white_close;
        // 标题栏字体颜色
        mPictureParameterStyle.pictureTitleTextColor = ContextCompat.getColor(getContext(), R.color.picture_color_white);
        ...
        mPictureParameterStyle.pictureWeChatLeftBackStyle = R.drawable.ic_white_back;
        // 相册列表底部背景色
        mPictureParameterStyle.pictureBottomBgColor = ContextCompat.getColor(getContext(), R.color.picture_color_grey);
        // 已选数量圆点背景样式
        mPictureParameterStyle.pictureCheckNumBgStyle = R.drawable.picture_num_oval;
            ...
            case PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE:
                ...
                for (int i = 0; i < grantResults.length; i++) {
                    if (grantResults[i] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Toast.makeText(MainPicActivity.this,
