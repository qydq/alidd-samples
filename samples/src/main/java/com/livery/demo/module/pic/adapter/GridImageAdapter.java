package com.livery.demo.module.pic.adapter;
...
import com.livery.demo.module.pic.listener.OnItemLongClickListener;
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                ...
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                        (R.drawable.ic_white_audio, 0, 0, 0);

            } else {
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                        (R.drawable.ic_white_video, 0, 0, 0);
            }
