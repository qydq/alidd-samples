...
public class BehaviorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pager_activity_behavior);
        ...
        mNavigationController = pageBottomTabLayout.material()
                .addItem(R.drawable.pager_ic_restore_teal_24dp, "Recents")
                .addItem(R.drawable.pager_ic_favorite_teal_24dp, "Favorites")
                .addItem(R.drawable.pager_ic_nearby_teal_24dp, "Nearby")
                .build();
    ...
    public static class TestFragment extends Fragment {
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            return inflater.inflate(R.layout.pager_fragment_recyclerview_double, container, false);
        }
